    ...
    <div class="reports-header app-page-hero">
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
            <div>
                ...
                <h2 class="app-page-hero-title mb-2">Generate Reports</h2>
                <p class="app-page-hero-subtitle">Create comprehensive reports for your ESP management system.</p>
            </div>
            <div class="d-flex gap-2 flex-wrap">
                <button class="btn btn-light app-page-hero-action" onclick="showPreview()">
                    <i class="bi bi-eye me-2"></i>Preview
                </button>
                <button class="btn btn-light app-page-hero-action" onclick="generateReport()">
        ...
        <div class="card-body">
            <form id="reportForm" method="POST" action="{{ route('admin.reports.generate') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label for="department" class="form-label">Building / Area (Optional)</label>
                        <select class="form-select" id="department" name="department">
                            <option value="">All Buildings and Areas</option>
                            @foreach(($departments ?? collect()) as $parent)
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white border-0 pt-4">
            ...
            <div class="table-responsive">
                <table class="table table-hover stackable-table">
                    <thead>
                        <tr>
                            <th>Report Type</th>
                            <th>Date Range</th>
                    ...
                    <tbody>
                        <tr>
                            <td data-label="Report Type"><span class="badge bg-primary">Attendance</span></td>
                            <td data-label="Date Range">May 2026</td>
                            <td data-label="Generated By">{{ auth()->user()->name }}</td>
                            <td data-label="Generated At">2026-05-05 17:30</td>
                            <td data-label="Format"><span class="badge bg-success">PDF</span></td>
                        ...
                        <tr>
                            <td data-label="Report Type"><span class="badge bg-info">Tasks</span></td>
                            <td data-label="Date Range">April 2026</td>
                            <td data-label="Generated By">{{ auth()->user()->name }}</td>
                            <td data-label="Generated At">2026-05-04 14:15</td>
                        ...
                        <tr>
                            <td data-label="Report Type"><span class="badge bg-warning">Leaves</span></td>
                            <td data-label="Date Range">Last 3 Months</td>
                            <td data-label="Generated By">{{ auth()->user()->name }}</td>
                            <td data-label="Generated At">2026-05-03 10:20</td>
                            <td data-label="Format"><span class="badge bg-success">PDF</span></td>
                            <td data-label="Actions">
                                <button class="btn btn-sm btn-outline-primary">
                                    <i class="bi bi-download"></i>
