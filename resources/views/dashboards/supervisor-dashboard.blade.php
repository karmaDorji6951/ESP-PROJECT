...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Supervisor Dashboard - ESP</title>
        ...
        <style>
            ...
            * {
            ...
            .sidebar-mark {
                ...
                display: grid;
                place-items: center;
                background: linear-gradient(135deg, var(--supervisor-accent) 0%, #60a5fa 100%);
                color: #ffffff;
            ...
            .stat-item.in-progress .stat-number { color: var(--supervisor-accent); }
            ...
            .status-in-progress {
                background: var(--supervisor-soft);
                color: #1e40af;
            }
    ...
    <body>
        ...
        <nav class="sidebar" id="sidebar">
            <a href="{{ route('dashboard') }}" class="sidebar-header">
                ...
                <div class="brand">
                    <h1>ESP Supervisor</h1>
                    <p>Team Management</p>
                </div>
            </a>

            <div class="nav-section">
                <div class="nav-label">My Dashboard</div>
            ...
            <div class="nav-section">
                ...
                <a href="{{ route('leaves.index') }}" class="nav-item">
                    📅 Leave Reviews
                    <span class="nav-badge">{{ $summary['pending_approvals'] }}</span>
                </a>
            </div>
        ...
        <div class="main-container">
            ...
            <div class="content">
                ...
                <div class="page-header">
                    ...
                    <p class="page-subtitle">Manage your team and approve requests</p>
                </div>
                ...
                <div class="kpi-grid">
                    <div class="kpi-card">
                        ...
                        <p class="kpi-label">Staff Under Supervision</p>
                ...
                <div class="panel">
                    ...
                    @else
                        <p style="color: var(--muted); text-align: center; padding: 20px;">✓ All leave requests have been processed</p>
                    @endif
                </div>
                ...
                <div class="panel">
                    ...
                    @else
                        <p style="color: var(--muted); text-align: center; padding: 20px;">You haven't assigned any tasks yet</p>
                    @endif
                </div>

                <!-- TODAY'S ATTENDANCE -->
                <div class="panel">
                    <h3>✓ Today's Attendance ({{ $staffAttendance->count() }})</h3>
                    ...
                    @else
                        <p style="color: var(--muted); text-align: center; padding: 20px;">No attendance records for today yet</p>
                    @endif
                </div>
            </div>

            <footer class="footer">
                <span>Employee Success Portal - Supervisor Dashboard</span>
